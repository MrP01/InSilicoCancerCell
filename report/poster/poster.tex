...
\begin{document}
  ...
  \node[anchor=east] at ([xshift=-1cm, yshift=-1cm]TP@title.east) {\includegraphics[height=4.0cm]{../logos/tugraz.pdf}};
  \node[anchor=east] at ([xshift=-9cm, yshift=-1cm]TP@title.east) {\includegraphics[height=5.2cm]{../logos/biotechmed-graz.eps}};
