...
\defineblockstyle{TUGrazBlockStyle}{
  ...
  titleinnersep=6mm, bodyinnersep=6mm, titlecenter
}{
...
\begin{document}
  \hypersetup{urlcolor=purple, linkcolor=purple, citecolor=purple}
  \renewcommand{\operatorcolor}{Accent}
  ...
  \begin{columns}
    ...
    \block{Introduction}{
      ...
      \textit{Schematic depiction of a cell, source: \cite{2024-calcium-channels}.}
      \vspace*{2mm}
    ...
    \column{0.75}
    \block{Live, In-Browser Cell Simulation Interface\vspace*{-0.16em}\hspace*{17cm}}{
