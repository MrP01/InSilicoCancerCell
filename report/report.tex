...
\begin{document}
  ...
  Given the individual ion channel type models' parameters, which we know from literature \Cref{table:channel-types}, the question that remains is how many channels there are of each type to fit the measurements.
  This problem can be solved using a number of optimization approaches.

  However, the formulation \Cref{eq:matrix-formulation} also gives rise to a least-squares formulation...
